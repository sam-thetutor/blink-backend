...
async function testBlink() {
  ...
  try {
    ...
    console.log('   Custom Transfer Parameters:', getData.links.actions[3].parameters.length);
    ...
    console.log('   x-blockchain-ids:', corsResponse.headers.get('x-blockchain-ids'));
    console.log('   x-action-version:', corsResponse.headers.get('x-action-version'));
    console.log('   Access-Control-Allow-Origin:', corsResponse.headers.get('Access-Control-Allow-Origin'));

    // Test 4: Test Icon Endpoint
    console.log('\n4️⃣ Testing Icon Endpoint...');
    const iconResponse = await fetch(`${BASE_URL}/api/actions/transfer-xlm/icon`);
