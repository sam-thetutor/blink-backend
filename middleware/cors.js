...
const corsMiddleware = (req, res, next) => {
  ...
  res.header('Access-Control-Allow-Headers', 'Content-Type, x-blockchain-ids, x-action-version');
  res.header('Access-Control-Expose-Headers', 'x-blockchain-ids, x-action-version');
